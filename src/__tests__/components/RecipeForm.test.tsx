...
describe('RecipeForm', () => {
  ...
  it('allows adding ingredients', async () => {
    ...
    const quantityInputs = screen.getAllByPlaceholderText('Quantity (e.g., 1/2, 3/4, 2)')
  ...
  it('allows removing ingredients', async () => {
    ...
    const quantityInputs = screen.queryAllByPlaceholderText('Quantity (e.g., 1/2, 3/4, 2)')
  ...
  it('submits form with correct data', async () => {
    ...
    const quantityInput = screen.getByPlaceholderText('Quantity (e.g., 1/2, 3/4, 2)')
  ...
  it('handles fraction input correctly', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByPlaceholderText('Quantity (e.g., 1/2, 3/4, 2)')).toBeInTheDocument()
    })
  ...
  it('pre-fills form with initial data', async () => {
    ...
    render(<RecipeForm onSubmit={mockOnSubmit} submitLabel="Update Recipe" initialData={initialData} />)
