          ...
          <section>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  When adding or editing a recipe, you can set a rating from 1
                  to 5. This helps you keep track of your favorite recipes.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Break down your instructions into clear, numbered steps. Each
                  step should be on a new line for better readability.
                </p>
              </div>
            </div>
          </section>
